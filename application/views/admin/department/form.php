<a href="<?php echo site_url('admin/department/index'); ?>"
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<input type="text" name="department"
					value="<?php echo ($this->input->post('department') ? $this->input->post('department') : $department['department']); ?>"
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<textarea name="description" id="description" class="form-control"
					rows="4" /><?php echo ($this->input->post('description') ? $this->input->post('description') : $department['description']); ?></textarea>
			</div>
		</div>
